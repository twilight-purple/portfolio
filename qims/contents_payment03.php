...
<!--   gnb/snb연결-->
   ...
   <div id="wrap">
	   ...
	   <ul class="title clear">
			<li></li>
			<li>안전결제 이용안내 상세 &nbsp;<span>안전결제 이용안내 상세를 확인하고 수정할 수 있습니다.</span></li>
		    <li class="title_right">
			  <input type="button" value="안전결제 이용안내 링크 복사" class="btn03" style="width:200px;">
		    </li>
		</ul>
	   <div class="ct">
		   <table class="tb01">
			   ...
			   <tr class="must">
				   ...
				   <td colspan="5">
				   		<input type="text" value="안전결제 이용안내" placeholder="50자까지 입력 가능" maxlength="50" style="width:70%">
				   </td>
			   </tr>
			   <tr class="must">
