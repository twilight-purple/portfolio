   ...
   <div id="wrap">
	   ...
	   <div class="mk02_01" style="position: relative;">
		   ...
		   <table class="tb01">
				<tr>
					<th>광고서비스</th>
					<td colspan="3">알림리스트 광고</td>
				</tr>
				<tr>
					<th>광고명 <span class="color">*</span></th>
					<td style="width:40%">
						<input type="text" name="tb_txt" value="[본사비공계정광고] 알림리스트 부산지역 광고 모바일 제휴" placeholder="40자까지 입력 가능" maxlength="40" style="width:90%">
					</td>
					...
					<td>
						<ul class="number_check clear">
							...
							<li>
								...
								<input type="text" name="tb_txt" value="나이키코리아" placeholder="업체명 입력" style="width:200px">
							</li>
						</ul>
					</td>
				</tr>
					...
					<td class="nm">
						<ul class="clear">
							...
							<li style="padding-top:14px;">
								...
								<span class="color">* 해당 지역이 ‘우리동네’로 설정 되어있는 회원에게 노출됩니다.</span>
							</li>
						</ul>
				   		<ol class="upper-roman none_nm clear">
							...
							<li>&nbsp;<b>삼성1동</b> <a class="qd-btn sml mgl5" href="#none">삭제</a></li>
						</ol>
					</td>
				</tr>
				<tr>
					...
					<td class="nm">
						<ul class="clear">
							...
							<li style="padding-top:14px;">
								...
								<span class="color">* 해당 카테고리가 ‘마이태그’로 설정 되어있는 회원에게 노출됩니다. (광고타입 '카테고리' 설정 시 필수)</span>
							</li>
						</ul>
						<ol class="upper-roman none_nm clear">
							<li>&nbsp;<b>패션의류</b> <a class="qd-btn sml mgl5" href="#none">삭제</a></li>
							<li>&nbsp;<b>패션잡화&#62;신발/구두/운동화</b> <a class="qd-btn sml mgl5" href="#none">삭제</a></li>
							<li>&nbsp;<b>패션잡화&#62;가방</b> <a class="qd-btn sml mgl5" href="#none">삭제</a></li>
							<li>&nbsp;<b>출산/유아동/교육&#62;유아동잡화&#62;책가방/여행가방</b> <a class="qd-btn sml mgl5" href="#none">삭제</a></li>
						</ol>
					</td>
				</tr>
				<tr>
					...
					<td class="nm">
						<ul class="clear mkrbbutton">
							...
							<li style="padding-top:14px;">
								...
								<input type="button" value="추가" class="btn03 ong" style="width:60px;">
								<span class="color">* 해당 카테고리가 ‘마이태그’로 설정 되어있는 회원에게 노출됩니다. (광고타입'키워드' 설정 시 필수)</span>
							</li>
						</ul>
					</td>
				</tr>
		   ...
		   <ul class="tb01_top clear">
			...
			<table class="tb01">
				<tr>
					<th>스토어 <span class="color">*</span></th>
					<td class="nm" style="padding-top:10px; padding-bottom: 10px;">
						<a class="qd-btn sml" href="#none">스토어 선택</a>
						<span class="color">* 알림리스트 광고는 스토어 선택에 따라 해당 스토어, 상품, 기회전으로 연결할 수 있습니다. (필수)</span>
						<ol class="upper-roman none_nm clear" style="margin-top:10px;">
							<li style="list-style: none;">&nbsp;<b>부산Tworld</b> <a class="qd-btn sml mgl5" href="#none">삭제</a></li>
						</ol>
					</td>
				</tr>
				<tr>
					...
					<td class="pd10-20 nm">
						...
						<ol class="upper-roman none_nm clear" style="margin: 10px 0 5px 0;">
							<li style="list-style: none;">&nbsp;<b>비밀의공구 X 부산 모바일 특가기획전</b> <a class="qd-btn sml mgl5" href="#none">삭제</a></li>
						</ol>
					</td>
				</tr>
				<tr>
				...
				<tr>
					<th>노출문구</th>
					<td>
						<input type="text" value="비밀의공구X부산 지역주민들을 위한 비공모바일 특가대전" placeholder="노출문구 입력 (최대 15자)" maxlength="15" style="width:50%">
						<span class="color">* 미입력 시 해당 스토어의 '소개글'이 기본으로 노출됩니다.</span>
					</td>
				</tr>
			</table>
