...
<!--   gnb/snb연결-->
   ...
   <div id="wrap">
	   ...
	   <ul class="title clear">
			<li></li>
			<li>로그인 서비스 소개 등록 &nbsp;<span>로그인 서비스 소개 등록 시 운영체제, 사용여부, 노출기간 설정, 이미지 첨부, 콘텐츠에 텍스트 추가하여 등록할 수 있습니다.</span></li>
		</ul>
	   <div class="ct">
		   <table class="tb01">
				<colgroup>
			   ...
			   <tr class="must">
				   ...
				   <td>
				   		<div class="file_wrap">
							...
							<span class="color fl_txtm">* 첨부한 순서대로 등록됩니다.</span>
				   		</div>
				   </td>
			   </tr>
			   <tr class="must">
			   ...
			   <tr>
				   <th>소개 콘텐츠 제목</th>
				   <td>
				   	<input type="text" value="" maxlength="50" style="width:900px">
				   	<span class="color fl_txtm">* 이미지에 노출됩니다.</span>
				   </td>
			   </tr>
			   <tr>
				   <th>소개 콘텐츠 상세설명</th>
				   <td class="textarea_wp">
				   	<textarea value="" placeholder="" maxlength="200" style="width:907px"></textarea>
					   <span class="color fl_txtm">* 이미지에 노출됩니다.</span>
				   </td>
			   </tr>
		   </table>
