...
<!--   gnb/snb연결-->
   ...
   <div id="wrap">
	   ...
	   <ul class="title clear">
			<li></li>
			<li>비밀의공구 상세</li>
			<li style="float: right;"><input type="button" value="비밀의공구 링크복사" style="width:140px;" class="btn03"></li>
		</ul>
	   <div class="vt01">
		   <table class="tb01">
			   <tr>
			   ...
			   <tr>
				   <th>제목(상품명)</th>
				   <td colspan="9"><input type="text" value="세인트스코트 스페셜에디션 시계 세트" placeholder="40자까지 입력가능" maxlength="40" style="width:70%;"></td>
			   </tr>
			   <tr class="vtcheck">
			   ...
			   <tr>
				   <th>영상</th>
				   <td colspan="9">
					   <div style="margin:10px 0;"><input type="url" value="http://goo.gl/zZb78J" placeholder="네이버TV 영상URL" style="width:70%;"></div>
					   <div>
						   <span class="color">
			   ...
			   <tr>
				   ...
				   <td class="imgbox_wrap" colspan="9">
				   		<div class="file_wrap">
							...
							<span class="color fl_txtm">* 여러 장 등록 가능하며, 첨부한 순서대로 등록됩니다.</span>
				   		</div>
					    <div class="imgbox02">
							<ul class="clear">
								<li>
			   ...
			   <tr>
				   ...
				   <td class="textarea_wp" colspan="9">
				   	<textarea name="list02_txt" value="" placeholder="1000자까지 입력가능" maxlength="1000" style="width:907px; height: 100px;">[ 세인트스코트 스페셜에디션 시계 세트 ]&#10;&#10;소가죽 시계밴드 11종, 메탈밴드 1종으로 다양한 스타일을 연출할 수 있는 세인트스코트 스페셜에디션 시계 세트</textarea>
				   </td>
			   </tr>
			   <tr class="vttxt">
				   ...
				   <td colspan="9">
					   <ul class="clear" style="float: left;">
							...
							<li>
								<label class="rdb">
									<input type="radio" name="rd3" checked="" class="bttxth">
									<span></span>사용
								</label>
							</li>
						</ul>
				   	<input type="url" value="" placeholder="고도몰 상품 상세페이지 URL, 밴드 URL 등" style="width:70%; float: left; margin-top:13px;">
				   </td>
			   </tr>
			   <tr>
				   <th>댓글</th>
