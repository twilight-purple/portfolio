...
//		snb바꾸기
		$(document).ready(function(){
			...
			$(".snb_wrap .snb>li:nth-child(4)>ul>li:nth-child(1)").addClass("on");
				   ...
				   <p class="tw_data">(YYYY-MM-DD ~ YYYY-MM-DD)</p>
					   ...
					   <div class="tw_in">
						   ...
						   <table class="twin_t">
							   <tr>
								   <th rowspan="2">날짜</th>
								   <th rowspan="2" class="y">신규가입</th>
								   <th rowspan="2" class="y02">전일대비</th>
								   <th colspan="3">APP 가입</th>
								   <th rowspan="2">WEB 가입</th>
								   <th rowspan="2">네이버 카페 연동</th>
							   </tr>
							   <tr>
							   ...
							   <tr>
								   ...
								   <td>1,000명</td>
								   <td>1,000명<span class="sm">(10%)</span></td>
							   </tr>
							   <tr>
								   <td>YYYY-MM-DD (N)</td>
					   ...
					   <div class="tw_in">
						   ...
						   <table class="twin_t">
							   <tr>
								   <th rowspan="2">요일</th>
								   <th rowspan="2" class="y">신규가입</th>
								   <th colspan="3" style="width:40%;">APP 가입</th>
								   <th rowspan="2">WEB 가입</th>
							   </tr>
							   <tr>
								   <th style="border-left:1px solid #ededed">iOS</th>
