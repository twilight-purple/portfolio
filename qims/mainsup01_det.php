...
<!--   gnb/snb연결-->
   ...
   <div id="wrap">
	   ...
	   <ul class="title clear">
			<li></li>
			<li>팝업 상세 &nbsp;<span>등록한 메인 팝업의 설정 내용을 변경할 수 있습니다</span></li>
		</ul>
	   <div class="ms01_01 v02">
		   <table class="tb01">
			   <tr>
			   ...
			   <tr>
				   ...
				   <td colspan="5">
				   <input type="url" name="tb_url" value="http://www.jongna.com" style="width:70%">
					   <span class="color fl_txtm">* 연결할 URL이 있을 경우에만 입력해주세요.</span>
				   </td>
			   </tr>
			   <tr>
				   <th>조회수</th>
				   <td width="15%">1,512</td>
				   <th>등록일</th>
				   <td>2018-01-01 13:15</td>
				   <th>등록자</th>
				   <td>민소연 (서비스기획팀)</td>
			   </tr>
			   <tr>
				   <th>제목 <span class="color">*</span></th>
				   <td class="tb_txt01" colspan="5"><input type="text" name="tb_txt" value="12월 택배이벤트" placeholder="50자까지 입력 가능" maxlength="50" style="width:70%"></td>
			   </tr>
			   <tr>
			   ...
			   <tr>
				   <td class="data" style="border-left:1px solid #ededed" colspan="5">
						특정 시간&nbsp;
						<select>
