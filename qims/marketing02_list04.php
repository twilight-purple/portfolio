...
<!--   타이틀-->
	   ...
	   <ul class="title clear">
			<li></li>
			<li>
				알림리스트 광고관리 &nbsp;<span>알림리스트 광고를 등록 및 관리할 수 있습니다. 알림리스트 광고는 스토어 선택에 따라 해당 스토어, 상품, 기획전으로 연결할 수 있습니다. (스토어 선택 필수)</span>
			</li>
		</ul>
<!--   타이틀-->
	<!--   검색영역-->
				   ...
				   <li class="on">
					   <table class="list">
						   <tr>
							   ...
							   <th>기기</th>
							   <th>운영체제</th>
							   <th style="width:5%;">스토어<br>프로필이미지</th>
							   <th>스토어명</th>
							   <th>노출문구</th>
							   <th>광고명</th>
							   <th>광고주</th>
						   ...
						   <tr class="y">
							   ...
							   <td class="a color">SKT해운대점</td>
							   <td>모바일 프로모션 특가대전</td>
							   <td class="a color">ABC마트 설 맞이 세일</td>
							   <td>ABC</td>
							   <td class="tal">0</td>
							   <td>2018-01-25</td>
							   <td>-</td>
