		   ...
		   <ul class="tb01_top clear">
			...
			<table class="tb01">
				<tr>
					...
					<td>
						<a class="qd-btn" href="#none">스토어 선택</a> <span class="color">* 알림리스트 광고는 스토어 선택에 따라 해당 스토어, 상품, 기획전으로 연결할 수 있습니다. (필수)</span>
					</td>
				</tr>
				<tr>
				...
				<tr>
					<th>노출문구</th>
					<td>
						<input type="text" name="tb_txt" value="" placeholder="노출문구 입력 (최대 15자)" maxlength="15" style="width:300px">
						<span class="color">* 미입력시 해당 스토어의 '소개글'이 기본으로 노출됩니다.</span>
					</td>
				</tr>
			</table>
		   <div class="mk_posi">
