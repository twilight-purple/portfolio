   ...
   <div id="wrap">
	   ...
	   <div class="mk02_01" style="position: relative;">
		   ...
		   <table class="tb01">
				<tr>
					<th>광고서비스</th>
					<td colspan="3">메인 저격상품 광고</td>
				</tr>
				<tr>
					<th>광고명 <span class="color">*</span></th>
					<td style="width:40%">
						<input type="text" name="tb_txt" value="메인저격_소보제화" placeholder="40자까지 입력 가능" maxlength="40" style="width:90%">
					</td>
					...
					<td>
						<ul class="number_check clear">
							...
							<li>
								...
								<input type="text" name="tb_txt" value="소보제화" placeholder="업체명 입력" style="width:200px">
							</li>
						</ul>
					</td>
				</tr>
					...
					<td class="nm">
						<ul class="clear">
				   		...
				   		<ol class="upper-roman none_nm clear">
							...
							<li>&nbsp;<b>지오다노</b> <a class="qd-btn sml mgl5" href="#none">삭제</a></li>
							<li>&nbsp;<b>청담푸르지오</b> <a class="qd-btn sml mgl5" href="#none">삭제</a></li>
						</ol>
					</td>
				</tr>
				<tr>
					...
					<td class="nm">
						...
						<ol class="upper-roman none_nm clear">
							<li>&nbsp;<b>수입명품&#62;여성신발&#62;구두</b> <a class="qd-btn sml mgl5" href="#none">삭제</a></li>
							<li>&nbsp;<b>패션잡화&#62;여성신발</b> <a class="qd-btn sml mgl5" href="#none">삭제</a></li>
						</ol>
					</td>
				</tr>
				<tr>
					...
					<td class="nm">
						...
						<ol class="upper-roman none_nm clear">
							<li>&nbsp;<b>면접구두</b> <a class="qd-btn sml mgl5" href="#none">삭제</a></li>
							<li>&nbsp;<b>펌프스힐</b> <a class="qd-btn sml mgl5" href="#none">삭제</a></li>
						</ol>
					</td>
				</tr>
				<tr>
