	   ...
	   <div class="mk02_01" style="position: relative;">
		   ...
		   <table class="tb01">
				...
				<tr>
					...
					<td style="width:40%">
						<input type="text" name="tb_txt" value="메인_마이태그 나이키코리아 중고나라 광고" placeholder="40자까지 입력 가능" maxlength="40" style="width:90%">
					</td>
				...
				<tr>
					...
					<td class="pd10-20 nm">
						...
						<ol class="upper-roman none_nm clear" style="margin: 10px 0 5px 0;">
							<li style="list-style: none;">&nbsp;<b>[중고나라X나이키] 팝니다 나이키본사 정품 이벤트중!</b> <a class="qd-btn sml mgl5" href="#none">삭제</a></li>
						</ol>
					</td>
				</tr>
			</table>
