...
<!--   gnb/snb연결-->
   ...
   <div id="wrap">
	   ...
	   <ul class="title clear">
			<li></li>
			<li>스플래시 등록 &nbsp;<span>스플래시 등록 시 운영체제, 사용여부, 노출기간 설정, 이미지를 첨부하여 등록할 수 있습니다.</span></li>
		</ul>
	   <div class="ct">
		   <table class="tb01">
				<colgroup>
			   ...
			   <tr class="must">
				   ...
				   <td><input type="text" value="" placeholder="50자까지 입력 가능" maxlength="50" style="width:60%"></td>
			   </tr>
			   <tr class="must">
